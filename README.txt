...
https://jackmappotion.com/category/programming/projects/krx-competition/
...
<구현 사항>
1. 구매할 종목을 선정하는 알고리즘
    1.1 구매할 종목을 선정했을때, 얼마나 구매할 것인지에 대해 선정하는 알고리즘

2. 판매할 종목을 선정하는 알고리즘
    2.1 판매할 종목을 선정했을때, 얼마나 판매할 것인지에 대해 선정하는 알고리즘
